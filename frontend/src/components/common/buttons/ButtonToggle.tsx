...
const ButtonToggle = ({ isChecked, ...props }: Props) => {
    ...
    return (
        <label
            className="relative inline-flex cursor-pointer items-center select-none"
        ...
        >
            ...
            />
            <div
                className={`shadow-card relative flex h-11.5 w-20.5 items-center justify-center rounded-md ${!isChecked ? 'bg-white' : 'bg-black'}`}
            >
                <div
